...
const PharmaBazarFooter = () => {
  return (
    <footer className="bg-[#1b85db]  bg-gradient-to-t  from-neutral-800 ... py-12 mt-20">
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white">
              <li><a  className="hover:text-gray-300 transition-colors">Home</a></li>
              <li><a className="hover:text-gray-300 transition-colors">About Us</a></li>
              <li><a className="hover:text-gray-300 transition-colors">Products</a></li>
              <li><a  className="hover:text-gray-300 transition-colors">Contact Us</a></li>
            </ul>
          </div>

          {/* Customer Support and Legal Links */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-100">Customer Support</h3>
            <ul className="space-y-2 text-white">
              <li><a  className="hover:text-gray-300 transition-colors">FAQs</a></li>
              <li><a className="hover:text-gray-300 transition-colors">Support Center</a></li>
              <li><a  className="hover:text-gray-300 transition-colors">Terms of Service</a></li>
              <li><a  className="hover:text-gray-300 transition-colors">Privacy Policy</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="flex space-x-6">
            <a href="https://www.facebook.com/PharmaBazar" aria-label="Facebook" className="text-gray-300 hover:text-gray-300 transition-colors">
            ...
            <a  aria-label="Twitter" className="text-gray-300 hover:text-gray-300 transition-colors">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a  aria-label="Instagram" className="text-gray-300 hover:text-gray-300 transition-colors">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
