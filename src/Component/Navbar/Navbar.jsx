    ...
    return (
        ...
        <div className="navbar-start   ">
          <div className="dropdown">
            ...
            <a className="text-lg  text-white " >  <NavLink   to="/need"> Shop </NavLink></a>
        ...
        <div className="navbar-center  hidden lg:flex">
          <ul className="menu menu-horizontal space-x-12 ">
           ...
           <a className="text-2xl text-white font-semibold " >  <NavLink   to="/need">Shop</NavLink></a>
              ...
              <li>
                <Link className=" text-lg  text-white    " to='/managePost'>Manage My Post
                     ...
                     {user ? <Link onClick={LogOut} className="  p-1 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white  text-xl   "  >Log Out</Link> 
                        :  <div >
                      <a className="text-2xl text-white lg:mx-3  " >    <NavLink  to="/login"> Joni Us   </NavLink></a>   
                      </div> }
                       </div>
                      </div>
