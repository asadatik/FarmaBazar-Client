...
{/*    Updated  or dlt */}
                ...
                <td className='lg:flex   gap-3 lg:py-2  ' >  <button  onClick={() => { setIsOpen(true); toHandle(i._id); }}    className='btn btn-sm btn-info  text-xl ' >Update</button>         
                   <button onClick={()=>handleDelete(i)}   className='btn btn-sm btn-secondary  text-xl ' >delete</button>  
                     </td>
