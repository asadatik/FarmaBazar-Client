...
const HomeGround = () => {
 ...
 {/* Category */}
             <div>
             <h1 className="lg:text-3xl font-bold my-6  uppercase text-center lg:tracking-[.25em]   md:w-2/4  border-y-4 border-blue-500  p-2 font-cinzel   mx-auto    " > Explore Category of Medicines </h1>
